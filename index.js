...
const id5 = document.querySelector("5");
const id6 = document.querySelector("6");
const id7 = document.querySelector("7");

const id8 = document.querySelector("8");
const id9 = document.querySelector("9");
const id10 = document.querySelector("10");
